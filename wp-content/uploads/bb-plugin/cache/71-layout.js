...
var wpAjaxUrl='http://localhost:8080/infortekcursos/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost:8080/infortekcursos/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://localhost:8080/infortekcursos/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://localhost:8080/infortekcursos/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);function initMap(map,position,zoom){map.setCenter(position);map.setZoom(zoom);var marker=new google.maps.Marker({position:position,map:map});}
var position={lat:34.0259216,lng:-118.77975709999998};initMap(new google.maps.Map(document.getElementById('map-module-59444bf346a13'),{scrollwheel:false}),position,8);