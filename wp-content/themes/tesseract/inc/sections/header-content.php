			...
			$wp_customize->add_control(
				...
				new WP_Customize_Control(
					...
					array(
						...
						'description' 		=> '<b><span style="font-color:blue; font-size:15px; font-family:caption;" ><a href="http://logomakr.com" target="_blank">Click here </a></span></b> to view a full list of buttons you can add to this area.',
